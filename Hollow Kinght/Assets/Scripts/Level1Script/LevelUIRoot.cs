...
public class LevelUIRoot : MonoBehaviour {
    ...
    public void Init()
    {
        ...
        menuMask = transform.Find("MenuMask").gameObject;
        keyPanel = transform.Find("keyPanle").gameObject;
        ...
        keySetBtn = transform.Find("MenuUI/ButtonObjs/keySetingBtn").GetComponent<Button>();
        btnOBjs.Add(continueBtn);
        btnOBjs.Add(restBtn);
        btnOBjs.Add(exitBtn);
        btnOBjs.Add(keySetBtn);
        ...
        keySetBtn.onClick.AddListener(OpenKeyPanle);
    ...
    public void OpenKeyPanle()
    {
        keyPanel.SetActive(true);
        menuUI.SetActive(false);
    }

    public void CloseKeyPanle()
    {
